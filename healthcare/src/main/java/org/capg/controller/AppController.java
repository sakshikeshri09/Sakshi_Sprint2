...
public class AppController {
	...
	public DiagnosticCenter convertDto(DiagnosticCenterDto centerDto) {
		...
		center.setCenterId(centerDto.getCenterName()+name);
...
//	}
	...
	public ResponseEntity<Test> removeTest(@PathVariable("centerId")String centerId,@PathVariable("testId")String testId){
		int count =0;
		DiagnosticCenter center=centerService.findById(centerId);
		List<Test> list=center.getTests();
